...
namespace DBProject.DAL
{
    ...
    public class myDAL
    {
        ...
        public void AddTheDoctor(string Name, string Email, string Password, string BirthDate, int dept, string Phone, char gender, string Address, int exp, int salary, int Charges_per_visit, string spec, string qual)
        {
            ...
            SqlCommand cmd = new SqlCommand("AddTheDoctor", con);
            cmd.CommandType = CommandType.StoredProcedure;
