               ...
               <div class="container">
                   ...
                   <div class="row">
                         <div class="col-sm-8 col-sm-offset-2 text">
                             <asp:Image ID="Image1" runat="server"  src="logo2.jpeg" />
                    ...
                    <div class="row">
                        ...
                        <!-- sign up form start honay laga hai :)-->
				            ...
				            <div class="form-group">
                                ...
                                <asp:TextBox ID="sBirthDate" runat="server" type="text" class="form-username form-control"  TextMode="Date" Font-Bold="True"></asp:TextBox>
           	                            
                            </div>

				            <div class="form-group">
				            
                                    <asp:TextBox ID="sEmail" runat="server" type="text" class="form-username form-control" placeholder="Email : person@example.com" TextMode="Email"></asp:TextBox>
