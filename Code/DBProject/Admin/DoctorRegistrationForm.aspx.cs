	...
	public partial class DoctorRegistrationForm : System.Web.UI.Page
	{
		...
		protected void DoctorRegister(object sender, EventArgs e)
		{
			...
			if (Page.IsValid)
			{
				...
				objmyDAL.AddTheDoctor(Name.Text, Email.Text, Password.Text, BirthDate.Text, dept, Phone.Text, gender[0], Address.Text, exp, salary, chargesPerVisit, spec.Text, Qualification.Text);
